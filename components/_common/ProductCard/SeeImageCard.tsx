...
const SeeImageCard = ({seeMore}: {seeMore: Href<LinkProps<string>>}) => {
  ...
  return (
      <TouchableOpacity activeOpacity={0.9} onPress={()=> router.navigate(seeMore)} className='bg-white w-[135px] h-[176px] rounded-md flex flex-row justify-center items-center'>
