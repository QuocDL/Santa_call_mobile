...
const SeeVideoCard = ({ seeMore }: { seeMore: Href<LinkProps<string>> }) => {
  const router = useRouter();
  return (
    <TouchableOpacity
      activeOpacity={0.9}
      onPress={() => router.navigate(seeMore)}
      className="bg-white w-[210px] rounded-md h-[130px] flex flex-row justify-center items-center"
    >
